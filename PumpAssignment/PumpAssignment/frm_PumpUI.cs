...
namespace PumpAssignment
{
    public partial class frm_PumpUI : Form
    {
        ...
        private void frm_PumpUI_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if ((e.KeyCode == Keys.D2 || e.KeyCode == Keys.NumPad2) && !m_systemController.PumpList[0].getActive())
            {
            ...
            if ((e.KeyCode == Keys.D3 || e.KeyCode == Keys.NumPad3) && !m_systemController.PumpList[1].getActive() && !m_systemController.PumpList[0].getActive())
            {
            ...
            if ((e.KeyCode == Keys.D8 || e.KeyCode == Keys.NumPad8) && !m_systemController.PumpList[6].getActive())
            {
            ...
            if ((e.KeyCode == Keys.D9 || e.KeyCode == Keys.NumPad9) && !m_systemController.PumpList[6].getActive() && !m_systemController.PumpList[7].getActive())
            {
